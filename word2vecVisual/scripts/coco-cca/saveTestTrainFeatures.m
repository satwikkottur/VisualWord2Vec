...
% Read the mat file
inPath = 'cca_workspace_coco_after.mat';
load(inPath);
...
dlmwrite(fullfile(dataPath, 'test_captions_coco_after_cca.txt'), textTestCCA, ...
                            'delimiter', ' ', 'precision', '%.6f');
dlmwrite(fullfile(dataPath, 'train_captions_coco_after_cca.txt'), textTrainCCA, ...
                            'delimiter', ' ', 'precision', '%.6f');
